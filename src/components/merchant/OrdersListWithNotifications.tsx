...
import { showNotification } from '../notifications/NotificationSystem';
...
export function OrdersListWithNotifications() {
  ...
  const updateOrderStatus = (orderId: string, newStatus: Order['status']) => {
    ...
    if (newStatus === 'preparing') {
      showNotification({
        type: 'order_accepted',
        title: 'Pedido Aceito',
        message: `Pedido #${orderId} foi aceito e está sendo preparado.`,
        orderId,
      });
      ...
      showNotification({
        type: 'order_ready',
        title: 'Pedido Pronto',
        message: `Pedido #${orderId} está pronto para entrega!`,
        orderId,
      });
    }
  };
